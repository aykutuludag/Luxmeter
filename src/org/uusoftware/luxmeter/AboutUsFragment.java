...
import org.uusoftware.luxmeter.adapter.Child;
import org.uusoftware.luxmeter.adapter.ExpandListAdapter;
import org.uusoftware.luxmeter.adapter.Group;
		...
		ExpandList.setOnChildClickListener(new OnChildClickListener() {
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 3) {
					...
					i.putExtra(Intent.EXTRA_SUBJECT, "Luxmeter");
					try {
